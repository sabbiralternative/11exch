...
const RemoveAccount = ({ setRemoveBank, removeBank }) => {
  const { refetchBankAccounts } = useBankAccountQuery({
        ...
        <div className="w-full flex items-center justify-center flex-col gap-y-4 mt-2">
          ...
          <div className="w-full flex items-center justify-center gap-x-2">
            ...
            <button
              ...
              className="inline-block leading-normal relative overflow-hidden transition duration-150 ease-in-out bg-primary text-base font-medium  text-white h-10 w-32 rounded-md flex items-center justify-center gap-x-1 cursor-pointer"
              type="button"
            >
