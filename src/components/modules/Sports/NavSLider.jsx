    ...
    <div className="h-max flex justify-center items-center pb-2">
      <div className="w-full h-max">
        <div className="flex items-center justify-start w-full overflow-auto no-scrollbar gap-1.5 px-2">
          ...
          <div className="flex items-center justify-between h-[65px] aspect-square flex-col border border-solid border-border_secondary3 pt-2 pb-1 rounded  bg-none cursor-pointer active:scale-95 transition-all ease-in-out duration-200">
            <p className=" w-7 h-auto flex items-center justify-center">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width={21}
          ...
          <div className="flex items-center justify-between h-[65px] aspect-square flex-col border border-solid border-border_secondary3 pt-2 pb-1 rounded  bg-none cursor-pointer active:scale-95 transition-all ease-in-out duration-200">
            <p className=" w-7 h-auto flex items-center justify-center">
              <img
                src="/assets/images/ExchLogos/menu-kabaddi.png"
                alt="Kabaddi"
                className="w-7 h-7"
              />
            </p>
          ...
          <div className="flex items-center justify-between h-[65px] aspect-square flex-col border border-solid border-border_secondary3 pt-2 pb-1 rounded  bg-none cursor-pointer active:scale-95 transition-all ease-in-out duration-200">
            <p className=" w-7 h-auto flex items-center justify-center">
              <img
                src="/assets/images/ExchLogos/SportIcon/menu-baseball.png"
                alt="Baseball"
                className="w-7 h-7"
              />
            </p>
          ...
          <div className="flex items-center justify-between h-[65px] aspect-square flex-col border border-solid border-border_secondary3 pt-2 pb-1 rounded  bg-none cursor-pointer active:scale-95 transition-all ease-in-out duration-200">
            <p className=" w-7 h-auto flex items-center justify-center">
              <img
                src="/assets/images/ExchLogos/SportIcon/menu-vollyBall.svg"
                alt="Vollyball"
                className="w-7 h-7"
              />
            </p>
          ...
          <div className="flex items-center justify-between h-[65px] aspect-square flex-col border border-solid border-border_secondary3 pt-2 pb-1 rounded  bg-none cursor-pointer active:scale-95 transition-all ease-in-out duration-200">
            <p className=" w-7 h-auto flex items-center justify-center">
              <img
                src="/assets/images/ExchLogos/SportIcon/menu-eCricket.svg"
                alt="E-cricket"
                className="w-7 h-7"
              />
            </p>
          ...
          <div className="flex items-center justify-between h-[65px] aspect-square flex-col border border-solid border-border_secondary3 pt-2 pb-1 rounded  bg-none cursor-pointer active:scale-95 transition-all ease-in-out duration-200">
            <p className=" w-7 h-auto flex items-center justify-center">
              <img
                src="/assets/images/ExchLogos/SportIcon/menu-HandBall.svg"
                alt="Handball"
                className="w-7 h-7"
              />
            </p>
          ...
          <div className="flex items-center justify-between h-[65px] aspect-square flex-col border border-solid border-border_secondary3 pt-2 pb-1 rounded  bg-none cursor-pointer active:scale-95 transition-all ease-in-out duration-200">
            <p className=" w-7 h-auto flex items-center justify-center">
              <img
                src="/assets/images/ExchLogos/SportIcon/menu-cycling.png"
                alt="Cycling"
                className="w-7 h-7"
              />
            </p>
          ...
          <div className="flex items-center justify-between h-[65px] aspect-square flex-col border border-solid border-border_secondary3 pt-2 pb-1 rounded  bg-none cursor-pointer active:scale-95 transition-all ease-in-out duration-200">
            <p className=" w-7 h-auto flex items-center justify-center">
              <img
                src="/assets/images/ExchLogos/SportIcon/menu-darts.svg"
                alt="Darts"
                className="w-7 h-7"
              />
            </p>
          ...
          <div className="flex items-center justify-between h-[65px] aspect-square flex-col border border-solid border-border_secondary3 pt-2 pb-1 rounded  bg-none cursor-pointer active:scale-95 transition-all ease-in-out duration-200">
            <p className=" w-7 h-auto flex items-center justify-center">
              <img
                src="/assets/images/ExchLogos/SportIcon/menu-snooker.png"
                alt="Snooker"
                className="w-7 h-7"
              />
            </p>
          ...
          <div className="flex items-center justify-between h-[65px] aspect-square flex-col border border-solid border-border_secondary3 pt-2 pb-1 rounded  bg-none cursor-pointer active:scale-95 transition-all ease-in-out duration-200">
            <p className=" w-7 h-auto flex items-center justify-center">
              <img
                src="/assets/images/ExchLogos/SportIcon/menu-nba2k19.svg"
                alt="NBA2K"
                className="w-7 h-7"
              />
            </p>
