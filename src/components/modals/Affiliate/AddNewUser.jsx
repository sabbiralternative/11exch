             ...
             >
              ...
              <div title="loginButton" className="w-full">
                <button
                  ...
                  type="submit"
                  className="inline-block leading-normal relative overflow-hidden transition duration-150 ease-in-out w-full text-white bg-bg_LoginButtonColor shadow-lg rounded-md xs:text-[15px] px-5 py-2 flex items-center justify-center gap-x-2 -bold font-medium text-base cursor-pointer disabled:cursor-not-allowed disabled:opacity-50"
                >
