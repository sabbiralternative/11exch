...
const Language = () => {
  ...
  return (
    <div className="z-[1000] fixed top-0 right-[0.5px] md:right-0 overflow-hidden flex w-full h-screen min-h-[100dvh] items-center justify-center bg-bg_CasinoPopupBg0]">
      <div
        ref={modalRef}
      ...
      >
                      ...
                      <button
                        ...
                        className={`relative overflow-hidden w-full px-3 py-2 text-sm font-medium rounded-md focus:outline-none focus:border-border_color_brand_primary  text-text_color_primary1 border-border_color_brand_primary ${
                          selectedLan === language
                            ? "bg-bg_LoginButtonColor text-white"
                            : ""
                        }`}
                        type="button"
                      >
        ...
        <div className="px-4 py-3 bg-bg_color_primary sm:px-6 sm:flex sm:flex-row-reverse">
          <button
            ...
            type="button"
            className="relative overflow-hidden inline-flex justify-center w-full px-4 py-2 text-base font-medium  bg-bg_LoginButtonColor border border-transparent rounded-md shadow-sm  focus:outline-none  sm:ml-3 sm:w-auto sm:text-sm "
          >
            Confirm
          </button>
          <button
            onClick={closeModal}
            type="button"
            className="relative overflow-hidden inline-flex justify-center w-full px-4 py-2 mt-3 text-base font-medium text-text_color_primary1 bg-bg_LoginButtonColor  rounded-md shadow-sm hover:bg-bg_color_secondary hover:border-border_color_brand_primary focus:outline-none focus:ring-2 focus:ring-offset-2  sm:mt-0 sm:ml-3 sm:w-auto sm:text-sm"
          >
            Cancel
          </button>
        </div>
